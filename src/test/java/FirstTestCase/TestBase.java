...
public class TestBase {
    ...
    public void setUp() {
        ...
        capabilities.setCapability("videoName", "HinkalnayaKatsoTestCaseForFirstSendOrder.mp4");
        capabilities.setCapability("name", "HinkalnayaKatsoTestCaseForFirstSendOrder");
